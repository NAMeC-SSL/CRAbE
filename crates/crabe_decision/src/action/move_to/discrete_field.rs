    ...
    pub fn print(&self) {
        ...
        for j in (0..self.y_len as usize).rev()  {
            for i in 0..self.x_len as usize {
                ...
                // }
                if mode == 1 {
                    if data[j][i].cost < 0.5 {
                        data[j][i].cost = 0.0;
                    } else if data[j][i].cost >= 0.5 && data[j][i].cost < 1.5 {
                        data[j][i].cost = 1.0;
                    } else if data[j][i].cost >= 1.5 && data[j][i].cost < 2.5 {
                        data[j][i].cost = 2.0;
                    } else if data[j][i].cost >= 2.5 && data[j][i].cost < 3.5 {
                        data[j][i].cost = 3.0;
                    } else if data[j][i].cost >= 3.5 && data[j][i].cost < 4.5 {
                        data[j][i].cost = 4.0;
                    } else if data[j][i].cost >= 4.5 && data[j][i].cost < 5.5 {
                        data[j][i].cost = 5.0;
                    } else if data[j][i].cost >= 5.5 && data[j][i].cost < 6.5 {
                        data[j][i].cost = 6.0;
                    } else if data[j][i].cost >= 6.5 && data[j][i].cost < 7.5 {
                        data[j][i].cost = 7.0;
                    } else if data[j][i].cost >= 7.5 && data[j][i].cost < 8.5 {
                        data[j][i].cost = 8.0;
                    } else if data[j][i].cost >= 8.5 && data[j][i].cost < 9.5 {
                        data[j][i].cost = 9.0;
                    } else if data[j][i].cost >= 9.5 {
                        data[j][i].cost = 10.0;
                    }

                    alpha = (range - data[j][i].cost).abs() / range;
                } else if mode == 0 {
                    if data[j][i].cost > 0.00001 && data[j][i].cost <= 10.0 {
                        alpha = (range - data[j][i].cost).abs() / range;
                    }
                } else {
